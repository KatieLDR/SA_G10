...
public class Song {
	...
	/*post*/
	public Song(String name, String cover, String artist, String album, String genre) {
		this.name = name;
		this.cover = cover;
		this.artist = artist;
		this.album = album;
	...
	/*get*/
	public Song(int id,String name,String cover,String artist,String album,int duration,String genre) {
		this.id = id;
		this.name = name;
		this.cover = cover;
		this.artist = artist;
